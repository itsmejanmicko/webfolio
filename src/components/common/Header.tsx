...
export default function Header() {
  ...
  return (
    <nav
  className={`fixed top-0 left-0 right-0 w-full bg-bg shadow-lg z-40 transform transition-transform duration-300  ${
    isVisible ? "translate-y-0" : "-translate-y-full"
  }`}
>
  <div className="flex items-center justify-between px-6 py-4 lg:px-24 lg:py-6 w-full">
    {/* Left Section */}
